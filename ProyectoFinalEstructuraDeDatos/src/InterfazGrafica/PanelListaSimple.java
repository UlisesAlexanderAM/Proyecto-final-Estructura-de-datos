			...
			if (texto.isBlank()){
				...
				switch (bandera) {
					case 0 -> {
						...
						listaTextPane.setText(listaSimple.mostrarLista());
						pack();
					}
					case 1 -> {
					...
					case 2 -> {
						listaSimple.eliminarElementos(dato);
						listaTextPane.setText(listaSimple.mostrarLista());
						pack();
					}
					case 3 -> {
						...
						if (texto2.isBlank()) {
							...
							listaSimple.modificarDatoNodo(dato, datoNuevo);
							listaTextPane.setText(listaSimple.mostrarLista());
							pack();
						}
					}
					case 4 -> {
						...
						if (texto2.isBlank()) {
							...
							double datoNuevo = Double.parseDouble(texto2);
							listaSimple.modificarDatoNodos(dato, datoNuevo);
							listaTextPane.setText(listaSimple.mostrarLista());
							pack();
						}
					}
